...
def build_useful_functs_c_file(dir_path, small_int, unsigned_small_int, big_int):
	with open(dir_path+"/useful_functs.c", "w") as f:
		...
		f.write("		return;\n\n")
		f.write("	mask = (1UL << RHO_LOG2) - 1;\n\n")
		f.write("	scalar_mult_lpoly(tmp_poly, poly_P0, (tmp->_mp_d[0]) & mask);\n")
		f.write("	add_lpoly(tmp_sum, tmp_sum, tmp_poly);\n\n")
		f.write("	mpz_tdiv_q_2exp (tmp, tmp, RHO_LOG2);\n\n")
		f.write("	if(tmp->_mp_size){\n")
		f.write("		scalar_mult_lpoly(tmp_poly, poly_P1, (tmp->_mp_d[0]) & mask);\n")
		f.write("		add_lpoly(tmp_sum, tmp_sum, tmp_poly);\n\n")
		f.write("		mpz_tdiv_q_2exp (tmp, tmp, RHO_LOG2);\n")
		f.write("	}\n\n")
		f.write("	i = 0;\n")
		f.write("	while(tmp->_mp_size){\n")
		f.write("		scalar_mult_lpoly(tmp_poly, polys_P[i++], (tmp->_mp_d[0]) & mask);\n")
		f.write("		add_lpoly(tmp_sum, tmp_sum, tmp_poly);\n\n")
		f.write("		mpz_tdiv_q_2exp (tmp, tmp, RHO_LOG2);\n")
		f.write("	}\n\n")
